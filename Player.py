...
class Player:
    ...
    def __init__(self, init, end, maze,bp):
        self.colors = [122, 125, 152, 155, 185, 91, 58, 89, 250]
        self.path = [init]
        self.maze = maze
        self.end = end
    ...
    def _isvaliddir(self, d):
        ...
        return self._inside(newpos[0],newpos[1]) and self.maze.getMaze()[newpos[0]][newpos[1]] == STONE and newpos not in self.path
